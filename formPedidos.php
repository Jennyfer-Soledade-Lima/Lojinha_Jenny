...
<div class="container mt-3">
  <h3>Informe os dados de cada pedido :</h3>
  ...
  <form action="/action_page.php" class="was-validated">
    ...
    <div class="mb-3">
      <label class="form-label">Rastreio do Frete:</label>
      <input type="text" class="form-control" id="pwd" placeholder="Enter password" name="pswd" required>
      <div class="valid-feedback">Validação</div>
      <div class="invalid-feedback">Por favor prencha esse campos corretamente</div>
    </div>
    <div class="mb-3">
     ...
     <div class="mb-3">
      <label class="form-label">Completo:</label>
      <input type="text" class="form-control" id="pwd" placeholder="Enter password" name="pswd" required>
      <div class="valid-feedback">Validação</div>
      <div class="invalid-feedback">Por favor prencha esse campos corretamente</div>
    </div>
      ...
      <div class="mb-3">
      <label class="form-label">Quantidade de devolução:</label>
      <input type="text" class="form-control" id="pwd" placeholder="Enter password" name="pswd" required>
      <div class="valid-feedback">Validação</div>
      <div class="invalid-feedback">Por favor prencha esse campos corretamente</div>
    </div>
